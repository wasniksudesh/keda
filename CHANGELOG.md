...
- **AWS DynamoDB Scaler**: Follow `LastEvaluatedKey` across query pages so `GetQueryMetrics` counts all matching items instead of only the first 1 MB response page ([#0000](https://github.com/kedacore/keda/issues/0000))
